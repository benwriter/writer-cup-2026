...
results.push(
  ...
  {name:'Final app and styles use cache-busting URLs',ok:indexSource.includes('styles.css?v=8-final-1')&&indexSource.includes('app.js?v=8-final-5'),detail:''},
  {name:'Service worker cache is refreshed for final V8',ok:workerSource.includes('writer-cup-2026-v8-final-5')&&workerSource.includes('app.js?v=8-final-5'),detail:''}
);
